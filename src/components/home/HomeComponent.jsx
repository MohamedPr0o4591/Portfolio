                ...
                >
                    <Stack gap={2}>
                        <Box className='first-side'>
                            ...
                            <span >
                                Junior Front End Developer| HTML, CSS, JavaScript Passionate about Creating Engaging Web Experience
                            </span>
                        </Box>
                        ...
                        <Stack gap={1}>
                            <ul className='list-unstyled d-flex gap-3'>
                                <li >
                                    <a href="https://www.facebook.com/lmohamedmokhtarl" target='_blank' className='box-icons'>
                                        <FacebookOutlined />
                                    </a>
                                </li>

                                <li >
                                    <a href="https://wa.me/+201022585956" target='_blank' className='box-icons'>
                                        <WhatsApp />
                                    </a>
                                </li>

                                <li >
                                    <a href="https://t.me/mohamedpr0o459" target='_blank' className='box-icons'>
                                        <Telegram />
                                    </a>
                                </li>
                                ...
                                <li >
                                    <a href="https://github.com/MohamedPr0o4591" target='_blank' className='box-icons'>
                                        <GitHub />
                                    </a>
                                </li>
                            </ul>
